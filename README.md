...
|---|---|---|
| [`pil`](https://github.com/renatawalkerj/pil) | A lightweight system for keeping an AI assistant honest and in-bounds across months of ongoing work — the actual rules, file formats, and a real caught error. It's file conventions and habits, not a tool with a UI. | — |
| [`job-search-pil`](https://github.com/renatawalkerj/job-search-pil) | A complete, reusable job-search system — tracking sheet, prompts, and two interactive tools — built from my own search and generalized so anyone can run it from scratch. | [Pipeline dashboard](https://claude.ai/code/artifact/a6b2c4f2-a6ff-4a40-8d16-bf60232ec0f7) · [Application tracker](https://claude.ai/code/artifact/bc25ac30-8555-4e1c-a7fe-8beaa476491f) · [Build your own](https://claude.ai/code/artifact/514e7208-b937-41b0-b287-ffae628572a8) |
